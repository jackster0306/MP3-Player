...
/**
 * ViewModel for the MusicPlayerActivity.
 */
public class MusicPlayerViewModel extends ViewModel {
    ...
    // LiveData for observing and updating the playback progress
    ...
    /**
     * Getter for the playback progress LiveData.
     *
     * @return MutableLiveData<Integer> representing the playback progress.
     */
    ...
    /**
     * Setter for the playback progress LiveData.
     *
     * @param progress The new playback progress to be set.
     */
